...
public class ArrayPracticeTest {
	...
	public void testSwap() {
		...
		int j = 1;
		int [] B = {1,3,2,4,5,6};
		ArrayPractice.swap( A, i, j);
		assertArrayEquals(B, A);
		
		int[]C = {4,5,8,9,2,4,8,34,7,9};
		i = 12;
		j=0;
		int [] D = {4,5,8,9,2,4,8,34,7,9};
		ArrayPractice.swap(C, i, j);
		assertArrayEquals(D,C);
	 ...
	 */
	 ...
	 public void testGetCol() {
		int[][] A = {{10,20,30,40}, 
					...
					{12,22,32,42}};
		int colNum = 1;
		int[] expResult = {20,21,22};
		int[] result = ArrayPractice.getCol(A, colNum); 
		assertArrayEquals(expResult, result);
		
		colNum = 9;
		int[] expResult2 = null;
		int[] result2 = ArrayPractice.getCol(A, colNum); 
